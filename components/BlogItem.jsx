...
const BlogItem = ({ blog }) => {
  ...
  return (
    <div className="bg-gray-900 p-4 border-2 border-green-200 mx-2 my-2 rounded-lg shadow-md">
      ...
      <span className="dark:text-white mx-3 px-2">
        likes: {optimisticLikes}
      </span>
      <span className="dark:text-white mx-3 px-2">
        upvotes: {optimisticUpvote}
      </span>
      ...
      <button
        type="button"
        onClick={() => addLikes(id)}
        className="rounded-lg cursor-pointer mx-2  bg-gray-800 text-center px-2 py-2  mt-6"
      >
        <FaThumbsUp
          size={"24"}
      ...
      {userHasLiked ? (
        <p className="text-white px-2 py-2">you liked this blog!</p>
      ) : (
        ""
      )}
      ...
      <button
        type="button"
        onClick={() => addVote(id)}
        className="rounded-lg cursor-pointer mx-2 bg-purple-700 text-center px-2 py-1  mt-4"
      >
        Vote me!
      </button>
    </div>
